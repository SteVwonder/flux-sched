...
sched=`readlink -e $dn/../simulator/sim_sched_fcfs.so`
rdlconf=`readlink -e $dn/../conf/hype-io.lua`

submit=`readlink -e $dn/../simulator/submit.so`
jobdata=`readlink -e $dn/../simulator/job_data/hype-test.csv`
...
sleep 1
flux kvs dir lwj | grep runrequest | sed 's/\./ /g' | sort -k 5 -k 2n | cut -d ' ' -f 2 > actual
