 ...
 */
int resrc_tree_serialize (json_object *o, resrc_tree_t *resrc_tree, int64_t jobid);
 ...
 */
int resrc_tree_list_serialize (json_object *o, resrc_tree_list_t *rtl, int64_t serialize);
